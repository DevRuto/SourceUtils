...
{
    /// <summary>
    /// Ported from SourceUtils.WebExport.Bsp.LightmapController, minus the HTTP layer.
    /// </summary>
    public static class LightmapService
    {
        public static Texture GetInfo( ValveBspFile bsp )
        {
            return new Texture
            {
                ...
                Elements =
                {
                    ...
                    {
                        Level = 0,
                        Url = $"/maps/{bsp.Name}/lightmap.png"
                    }
                }
            };
        }

        public static void WriteImage( ValveBspFile bsp, Stream output )
        {
